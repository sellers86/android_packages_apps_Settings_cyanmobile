...
public class DeviceInfoSettings extends PreferenceActivity {
    ...
    private String procVersionStr = "unavailable";
    ...
    protected void onCreate(Bundle icicle) {
        ...
        setStringSummary("device_total_memory", getTotalMemAvail().toString()+" MB / "+getTotalMemTotal().toString()+" MB CMobile");
   ...
   private String getCPUInfo() {
    ...
    private String getFormattedKernelVersion() {
        try {
            InputStream is = new FileInputStream("/proc/version");
