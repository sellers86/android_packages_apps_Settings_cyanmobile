...
public class SecuritySettings extends PreferenceActivity implements OnPreferenceChangeListener {
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        addPreferencesFromResource(R.xml.security_settings_finder);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        if (KEY_UNLOCK_SET_OR_CHANGE.equals(key)) {
            ...
            if (isToggled(preference) && (Settings.System.getInt(getContentResolver(), Settings.System.SHOW_STATUS_CLOCK, 1) == 1)) {
                Settings.System.putInt(getContentResolver(), Settings.System.SHOW_STATUS_CLOCK, 0);
            } else {
