...
public class SoundSettings extends PreferenceActivity implements
    ...
    private static final String KEY_POWER_BATTERYFULL = "power_batteryfull";
    private static final String KEY_POWER_BATTERYLOW = "power_batterylow";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPowerBatteryFull = (CheckBoxPreference) findPreference(KEY_POWER_BATTERYFULL);
        mPowerBatteryFull.setPersistent(false);
        mPowerBatteryFull.setChecked(Settings.System.getInt(resolver,
                Settings.System.POWER_BATTERYFULL_ENABLED, 1) != 0);
        mPowerBatteryLow = (CheckBoxPreference) findPreference(KEY_POWER_BATTERYLOW);
        mPowerBatteryLow.setPersistent(false);
        mPowerBatteryLow.setChecked(Settings.System.getInt(resolver,
                Settings.System.POWER_BATTERYLOW_ENABLED, 1) != 0);

        mAnnoyingNotifications = (ListPreference) findPreference(PREF_LESS_NOTIFICATION_SOUNDS);
        mAnnoyingNotifications.setOnPreferenceChangeListener(this);
        mAnnoyingNotifications.setValue(Integer.toString(Settings.System.getInt(resolver,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        } else if (preference == mPowerBatteryFull) {
            Settings.System.putInt(getContentResolver(), Settings.System.POWER_BATTERYFULL_ENABLED,
                    mPowerBatteryFull.isChecked() ? 1 : 0);

        } else if (preference == mPowerBatteryLow) {
            Settings.System.putInt(getContentResolver(), Settings.System.POWER_BATTERYLOW_ENABLED,
                    mPowerBatteryLow.isChecked() ? 1 : 0);
